...
public class ComputeYears {
    ...
    public static Schema getProjectionSchema() throws IOException {
        ...
        FSDataInputStream is = fs.open(new Path("hdfs:///projection_schema.parquet"));
    ...
    public static Schema getYearSchema() throws IOException {
        ...
        FileSystem fs = FileSystem.get(new Configuration());
        FSDataInputStream is = fs.open(new Path("hdfs:///year_schema.parquet"));
        byte[] Bytes = ByteStreams.toByteArray(is);
        String ps = new String(Bytes);
        MessageType mt = MessageTypeParser.parseMessageType(ps);
        return new AvroSchemaConverter().convert(mt);
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        TextInputFormat.setInputPaths(job, new Path("hdfs:///to_parquet_output"));
        ...
        FileOutputFormat.setOutputPath(job, new Path("hdfs:///compute_years_output"));
