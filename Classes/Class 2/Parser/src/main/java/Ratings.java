...
public class Ratings {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        // Input configuration
        MultipleInputs.addInputPath(job,new Path("/Users/goncalo/Documents/University/Year 4/CD/GGCD/Classes/IMDb Datasets/Mini/title.basics.tsv.bz2"), TextInputFormat.class, MyMapper.class);
        MultipleInputs.addInputPath(job,new Path("/Users/goncalo/Documents/University/Year 4/CD/GGCD/Classes/IMDb Datasets/Mini/title.ratings.tsv.bz2"), TextInputFormat.class, MyMapper2.class);
