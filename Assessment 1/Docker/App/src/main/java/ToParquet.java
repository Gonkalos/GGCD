...
public class ToParquet {
    ...
    public static Schema getSchema() throws IOException, OutOfMemoryError {
        ...
        FSDataInputStream is = fs.open(new Path("hdfs:///movie_schema.parquet"));
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        // Input configuration
        MultipleInputs.addInputPath(job, new Path("hdfs:///title.basics.tsv.bz2"), TextInputFormat.class, BasicsMapper.class);
        MultipleInputs.addInputPath(job, new Path("hdfs:///title.ratings.tsv.bz2"), TextInputFormat.class, RatingsMapper.class);
